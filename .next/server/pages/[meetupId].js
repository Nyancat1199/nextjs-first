...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://Irsyaditama:irsyad123@cluster0.ek4qz.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
...
/* harmony default export */ var _meetupId_ = __webpack_exports__["default"] = (DetailsMeetup);
